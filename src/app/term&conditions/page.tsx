...
const TermsAndConditions = () => {
  return (
    <div className="terms-conditions-page bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 p-6 lg:pt-20 pb-16">
      <h1 className="text-6xl font-bold mb-4 text-center">Terms and Conditions</h1>
      <h1 className="text-2xl font-extralight mb-4 text-center">for Tecnologia LLC</h1>

      
      <h2 className="text-2xl font-semibold mb-2">Who we are</h2>
      <p className="mb-4">
      Suggested text: Our website address is: <a href='https://konstruktion.demo.vamtam.com.' className='hover:text-blue-600 hover:underline'>https://konstruktion.demo.vamtam.com.</a>
      </p>
...
These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracking your interaction with the embedded content if you have an account and are logged in to that website.      </p>
      ...
      <h2 className="text-2xl font-semibold mb-2">Who we share your data with
      </h2>
      <p className="mb-4">
      Suggested text: If you request a password reset, your IP address will be included in the reset email</p>
      <h2 className="text-2xl font-semibold mb-2">How long we retain your data
      </h2>
      <p className="mb-4">
